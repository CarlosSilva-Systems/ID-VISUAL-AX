                ...
                <tr key={u.id} className="bg-slate-50/50 hover:bg-slate-50 transition-colors group">
                  ...
                  <td className="px-4 py-4">
                    <span className={cn(
                      ...
                      u.role === 'ti' ? "bg-blue-50 text-blue-700 border-blue-100" :
                      u.role === 'gerencia' ? "bg-purple-50 text-purple-700 border-purple-100" :
                      u.role === 'producao' ? "bg-emerald-50 text-emerald-700 border-emerald-100" :
