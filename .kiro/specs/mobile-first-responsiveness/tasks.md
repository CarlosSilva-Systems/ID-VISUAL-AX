...
- [ ] 1.1 Adicionar utilitários CSS globais em `theme.css`
...
- [ ] 1.2 Criar hook `useReducedMotion`
...
- [ ] 2.1 Criar componente `BottomSheet`
...
- [ ] 2.2 Criar componente `ActionMenu`
...
- [ ] 2.3 Criar componente `FilterBar`
...
- [ ] 3.1 Refatorar `Layout.tsx` — Sidebar mobile
...
- [ ] 3.2 Refatorar `Layout.tsx` — Topbar busca expansível mobile
...
- [ ] 3.3 Refatorar `Layout.tsx` — Topbar elementos mobile
...
- [ ] 3.4 Refatorar `Layout.tsx` — Touch targets da Sidebar
...
- [ ] 4.1 Refatorar `Dashboard.tsx` — StatCards e filtros
...
- [ ] 4.2 Refatorar `Dashboard.tsx` — DashboardRow mobile
...
- [ ] 4.3 Refatorar `Solicitacoes.tsx` — Card View mobile
...
- [ ] 4.4 Refatorar `Solicitacoes.tsx` — Bottom sheet para drawer
...
- [ ] 4.5 Refatorar `DevicesPage.tsx` — Card View e ActionMenu
...
- [ ] 4.6 Refatorar `DevicesPage.tsx` — Bottom sheet para DeviceDrawer
  - Em `< md`: renderizar `DeviceDrawer` como `<BottomSheet maxHeight="90vh">`
  - Abas internas: cada aba com `overflow-y-auto` independente
  - **Requisitos:** 6.5

- [ ] 4.7 Refatorar `AndonPendenciasPage.tsx` — Card View e filtros
...
- [ ] 5.1 Refatorar `AndonGrid.tsx` — Hover e touch
...
- [ ] 5.2 Refatorar `OTASettings.tsx` — Responsividade
...
- [ ] 5.3 Refatorar `OTAProgressDashboard.tsx` — Responsividade
  - Container: `p-4 sm:p-6 lg:p-8`
...
- [ ] 5.4 Refatorar `Configuracoes.tsx` — Abas e formulários
...
- [ ] 5.5 Refatorar `ProductionViewUI.tsx` — Bottom sheet e CTA
...
- [ ] 5.6 Refatorar `AndonOperador.tsx` — Bottom sheet e grid mobile
  - Modal de motivo: `<BottomSheet>` em `< sm`
  - Grid de botões de cor: `grid-cols-3` com `min-h-[64px]` em mobile
  - **Requisitos:** 12.8

- [ ] 5.7 Refatorar `ConfirmModal.tsx` — Bottom sheet mobile
...
- [ ] 5.8 Refatorar `ModalPacote.tsx` e `JustificationModal.tsx` — Bottom sheets
  - Em `< sm`: renderizar como `<BottomSheet maxHeight="95vh">`
  - Em `>= sm`: manter modal centralizado atual
  - **Requisitos:** 12.3, 12.4

- [ ] 5.9 Aplicar tipografia responsiva global
...
- [ ] 5.10 Implementar virtualização para listas longas
...
- [ ] 5.11 Aplicar touch targets globais e hover/active states
...
- [ ] 5.12 Refatorar `AndonOEEDashboard.tsx` — Gráficos responsivos
...
- [ ] 5.13 Aplicar sombras reduzidas em mobile
